  ...
  private void startRecording() {
    ...
    if (camcorderProfile != null) {
      ...
      if(maximumWidth >= displayMetrics.widthPixels && maximumHeight >= displayMetrics.heightPixels) {
        ...
        // If not then we calculate new width or height to preserve aspect ratio
        if(isLandscape) {
          maximumWidth = displayMetrics.widthPixels * maximumHeight / displayMetrics.heightPixels;
        } else {
          maximumHeight = displayMetrics.heightPixels * maximumWidth / displayMetrics.widthPixels;
        }
      }
    } else {
